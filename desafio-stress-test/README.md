...
```shell
docker build -t josimar16/goexpert/desafio-stress-test:v1 .
docker run josimar16/goexpert/desafio-stress-test:v1 -—url=http://google.com -—requests=10 —-concurrency=2
```
